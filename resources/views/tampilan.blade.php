  ...
  <div class="main app form" id="main"><!-- Main Section-->
    <div class="hero-section">
      <div class="container nopadding">
        <div class="col-md-5"> <img class="img-responsive wow fadeInUp" data-wow-delay="0.1s" src="{!! asset('dist/img/large_logo.png') !!}" alt="App" /> </div>
        <div class="col-md-7">
          <div class="hero-content">
            <h1 class="wow fadeInUp" data-wow-delay="0.1s">Atqiya's Fun Learning</h1>
            <p class="wow fadeInUp" data-wow-delay="0.2s"> Selamat datang di Atqiya's Fun Learning. (AFL adalah tempat les privat Bandung, guru datang ke rumah siswa/i, harga terjangkau, mayoritas guru anak ITB, daftar kapanpun, les fisika, les kimia, les biologi, les matematika, les bahasa inggris. 
            Pendaftaran dan informasi lebih lanjut, hubungi kami di Telp/ SMS/ WA/ LINE : 085659923614  </p>
